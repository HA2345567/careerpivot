...
export const Dashboard = ({ user, onLogout }: DashboardProps) => {
  ...
  const renderContent = () => {
    switch(activeTab) {
      ...
      default: return <OverviewTab user={currentUser} setTab={setActiveTab} />;
    }
  };
...
const OverviewTab = ({ user, setTab }: { user: UserContextType, setTab: (t: Tab) => void }) => {
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="space-y-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
            <Card className="p-5 border-l-4 border-l-red-500 bg-zinc-900/30 hover:bg-zinc-900/60 cursor-pointer group transition-all" onClick={() => setTab('bot')}>
            ...
            <Card className="p-5 border-l-4 border-l-emerald-500 bg-zinc-900/30 hover:bg-zinc-900/60 cursor-pointer group transition-all" onClick={() => setTab('bot')}>
                <div className="flex justify-between items-start mb-4">
