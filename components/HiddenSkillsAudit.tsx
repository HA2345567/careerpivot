    ...
    try {
      ...
      if (process.env.API_KEY) {
        ...
        const response = await ai.models.generateContent({
          ...
          contents: `Analyze the following professional background or job description. 
          Identify 4 specific, high-value transferable skills that this person might not realize they have (avoid generic terms like 'communication', be specific). 
          Also suggest 3 alternative career paths/job titles outside their current industry that would value these skills.
